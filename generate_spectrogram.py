...
def convert_audio_to_mel_spectrogram(filename,mood):
...
if __name__ == '__main__':
    ...
    for mood in mood_lists:
        os.makedirs("spectrogram/"+mood,exist_ok=True)
        for filename in os.listdir("extract/"+mood):
            convert_audio_to_mel_spectrogram("extract/"+mood+"/"+filename,mood)
            count += 1
